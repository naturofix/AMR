...
shinyUI(fluidPage(
  ...
  tabPanel('Regression',tabsetPanel(
    tabPanel('Linear Regression',
             column(4,uiOutput('linear_regression_first_ui')),
             column(4,uiOutput('linear_regression_cont_ui')),
             column(4,uiOutput('linear_regression_disc_ui')),
             column(12,
                #selectInput('lm_chart_method','Correlation Method',c("pearson", "kendall","spearman")),
                plotOutput('lm_chart_correlation',height = 800)
                ),
             column(12,
               plotOutput('lm_plot'),
               dataTableOutput('lm_data_table')
             ...
             column(12,
                    verbatimTextOutput('lm_model_text'),
                    verbatimTextOutput('lm_model_summary_text')),
             ...
             column(12,
                    ...
                    tags$h4('ANOVA'),
                    verbatimTextOutput('lm_anova_text'),
                    verbatimTextOutput('lm_anova_summary_text'),
    ...
    tabPanel('Logistic Regression',
             column(4,uiOutput('slr_continuous_select_ui')),
             column(4,uiOutput('slr_factors_select_ui')),
             # column(4,selectInput('slr_family_1','Family',c(binomial(link = "logit"),
             ...
             #column(4,radioButtons('slr_normalise','Normalise to 0-1',c(F,T))),
             column(12,
              #selectInput('slr_chart_method','Correlation Method',c("pearson", "kendall","spearman")),
              plotOutput('slr_chart_correlation',height = 800),
               plotOutput('slr_plot'),
               dataTableOutput('slr_data_table'),
               tags$h3(htmlOutput('slr_model_formula')),
               selectInput('slr_family','Family',c("binomial(link = 'logit')",
                                                            "gaussian(link = 'identity')",
                                                            "Gamma(link = 'inverse')",
                                                            "inverse.gaussian(link = '1/mu^2')",
                                                            "poisson(link = 'log')",
